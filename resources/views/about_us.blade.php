        ...
        <div class="container">
            ...
            <div class="row about_row">
                <div class="col-md-5 col-sm-6 about_client about_pages_client">
                    <img src="{{URL::asset('storage/theme/images/feature-man-3.jpg')}}" alt="">
                </div>
        ...
        <div class="container">
            ...
            <div class="feature_row row">
                <div class="col-md-6 feature_img">
                    <img src="{{URL::asset('storage/theme/images/feature-man.jpg')}}" alt="">
                </div>
        ...
        <div class="container">
            ...
            <div class="row team_row">
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
                   <div class="team_membar">
                        <img src="{{URL::asset('storage/theme/images/team/tm-2.jpg')}}" alt="">
                        <div class="team_content">
                            <ul>
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.6s">
                   <div class="team_membar">
                        <img src="{{URL::asset('storage/images/team/tm-4.jpg')}}" alt="">
                        <div class="team_content">
                            <ul>
                                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
